<?php $title="Driver Notifications"; include(APPPATH.'views/_partials/header.php'); ?>
<?php $page_title="Notifications"; $logout_url="driver/driver_auth/logout"; include(APPPATH.'views/_partials/topbar.php'); ?>
